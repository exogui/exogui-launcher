...
export function ConfigBoxInner(
    props: React.PropsWithChildren<ConfigBoxProps>,
) {
    return (
        <div className="setting__inner__row">
            ...
            <div>
                {props.swapChildren && (
                    <p className="setting__row__description">
                        {props.description}
                    </p>
                )}
...
export function ConfigBox(props: React.PropsWithChildren<ConfigBoxProps>) {
    return (
        <div className="setting__row">
            <div
                className={`setting__row__top ${props.swapChildren ? "setting__row__top--swapchildren" : ""}`}
            >
                <p className="setting__row__title">{props.title}</p>
                <div
                    className={`setting__row__content ${props.contentClassName || ""} ${props.swapChildren ? "setting__row__content--bottom-margin" : ""}`}
                >
                    {props.swapChildren && (
                        <p className="setting__row__description">
                            {props.description}
